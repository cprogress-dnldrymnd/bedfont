...
$Products = new newPostType();
$Products->name = 'Products';
$Products->singular_name = 'Product';
$Products->icon = 'dashicons-products';
$Products->supports = array('title', 'revisions', 'editor', 'thumbnail', 'excerpt', 'author');
$Products->show_in_rest = true;
$Products->rewrite = array(
    'with_front' => false,
    'slug' => 'capabilities'
);
